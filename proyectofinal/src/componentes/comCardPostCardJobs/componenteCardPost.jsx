...
function CardPost({imagenPerfil,nombre,key,body,ChangeComentario1,crearComentario,keyComent,onClick,clickEx,nombreComentario,comentario}){
    ...
    return(
        <div className="card mx-auto mt-4" key={key}>
            ...
            <img src={require('../../images/imageDefecto.png')} className="card-img-top cursor-pointer" onClick={clickEx}   />
